export class CanvasLocal {
    constructor(ctx, canvas) {
        this.anchoTotal = 12; // Ancho en unidads lójikas
        this.altoTotal = 8; // Alto en unidads lójikas
        this.ctx = ctx;
    ...
    dibujarBarra(x, porzentaje, color, etiketa) {
    ...
    dibujarBarra3D(x, altura, color) {
        ...
        if (altura > 0.5) {
            ...
            this.ctx.beginPath();
            this.ctx.moveTo(this.aX(x - 0.5), this.aY(this.altoTotal - 2));
            this.ctx.lineTo(this.aX(x), this.aY(this.altoTotal - 1.5));
