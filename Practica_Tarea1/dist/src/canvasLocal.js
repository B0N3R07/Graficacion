export class CanvasLocal {
    ...
    iX(x) { return Math.round(this.centerX + x / this.pixelSize); } //Covertimos a pixeles x
    iY(y) { return Math.round(this.centerY - y / this.pixelSize); } //convertimos a pixeles Y
    //Dibujado
    ...
    paint() {
        ...
        const inicioY = (this.maxY - sizeofsquare) / 2;
        ; //tanño del cuadrado /2 para Y
